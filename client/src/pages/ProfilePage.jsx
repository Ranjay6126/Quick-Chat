    ...
    <div className="min-h-screen bg-cover bg-no-repeat flex items-center justify-center">
      <div className="w-5/6 max-w-2xl backdrop-blur-2xl text-gray-300 border-2 border-gray-600 flex items-center justify-between max-sm:flex-col-reverse rounded-lg shadow-lg">
        <form onSubmit={handleSubmit} className="flex flex-col gap-5 p-10 flex-1">
          ...
          <label htmlFor="avatar" className="flex items-center gap-3 cursor-pointer hover:text-violet-400 transition">
            <input
            ...
            <img
              ...
              alt="Avatar"
              className={`w-12 h-12 border border-gray-500 object-cover ${selectedImg && "rounded-full"}`}
            />
